    ...
    group('should return hives with matching visits', () {
      ...
      test('should return matching behavior', () async {
        ...
        for (Visit visit in result[0].visits)
          if (visit is RegularVisit) expect(visit.behavior, query);
      });
    });
  });
}
